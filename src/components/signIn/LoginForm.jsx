    ...
    return (
        <form className={`bg-black/70 w-full ${ isSignUP ? "h-[42rem] lg:h-[44.5rem]" : "h-[38.5rem] lg:h-[41rem]" } overflow-hidden lg:w-[35%] px-8 lg:px-14 py-8 transition-all duration-200 ease-linear mt-18 lg:mt-28`}>
            ...
            <div className="flex flex-col gap-4.5">
                ...
                {
                    isSignUP && <EntryDiv inputChangeHandler={inputChangeHandler} formData={formData} name="userName" placeholder="Your name" isSmall={isSmall} type="text" errorMsg="Please enter a valid name." />
                }
                ...
                {
                    !isSignUP && <span className="text-white font-semibold text-center underline lg:text-lg cursor-pointer hover:text-gray-300 transition-all duration-100 ease-linear">Forgot password?</span>
                }
