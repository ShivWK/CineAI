...
const Login = () => {
  return (
    <main className='relative w-full h-full flex justify-center bg-gradient-to-b from-[rgba(0,0,0,0.7)] from-10% via-[rgba(0,0,0,0.4)] to-[rgba(0,0,0,0.8)] to-90% pb-14'>
