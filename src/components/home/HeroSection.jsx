...
const HeroSection = () => {
    return (<section className='relative h-[100vh] w-full flex items-center justify-center bg-gradient-to-b from-[rgba(0,0,0,0.8)] from-10% via-[rgba(0,0,0,0.4)] to-[rgba(0,0,0,0.8)] to-90%'>
        <Header />
